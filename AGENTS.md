...
- **Data sync:** jsonbin.io (bin id + master key hardcoded in the script). Cloud is source of truth; localStorage caches locally and reconciles on focus/visibility change every 30s.
